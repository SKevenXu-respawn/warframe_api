...
public class itemurlget {
    ...
    public payload items_detail(String file) {
        ...
        Gson gson = new Gson();
        pay = gson.fromJson(text, payload.class);

        return pay;
    }

    public payload url_detail(String urlpath) {
        String text = null;
        try {

            URL url = new URL(urlpath);
            // "https://api.warframe.market/v1/items"
            // https://api.warframe.market/v1/riven/items
        ...
        pay = gson.fromJson(demo.payload, payload.class);
        return pay;
    ...
    public String[] getthumb() {
        ...
        String[] thumb = new String[pay.items.size()];
        for (int i = 0; i < thumb.length; i++) {
            thumb[i] = pay.items.get(i).thumb;
        }
        return thumb;
    }
